...
@section('content')
    ...
    flex
    flex-col">
        <div class="text-5xl sm:text-6xl lg:text-8xl text-center font-bold">NBACREPAIR</div>
        <div class="text-4xl sm:text-5xl lg:text-7xl text-center m-5 font-semibold">SYSTEM</div>
        <div class="text-2xl sm:text-3xl lg:text-4xl text-center">ระบบแจ้งซ่อมเครื่องคอมพิวเตอร์</div>
    </div>
    <div class="container mx-auto px-5 my-20">
        <div class="text-center font-semibold text-gray-700 text-5xl lg:text-7xl">NBACREPAIR SYSTEM</div>
        <li class="text-left font-semibold text-gray-700 lg:text-4xl mt-10">Nbac repair system คืออะไร ?</li>        
        <p class="text-left font-semibold text-gray-500 lg:text-2xl mt-5 ml-13">NBAC Repair System คือระบบที่ถูกพัฒนาขึ้นมาเพื่อใช้ในการแจ้งซ่อมเครื่องคอมพิวเตอร์เมื่อเกิดความเสียหาย หรือเมื่อต้องการตรวจสอบสภาพเครื่องคอมพิวเตอร์แต่ละเครื่องอย่างเป็นระบบ โดยเน้นความสะดวก รวดเร็ว และมีประสิทธิภาพในการจัดการปัญหาด้านอุปกรณ์คอมพิวเตอร์ภายในองค์กร</p>
        <li class="text-left font-semibold text-gray-700 lg:text-4xl mt-10">Nbac repair system เกิดขึ้นได้อย่างไร ?</li>        
        <p class="text-left font-semibold text-gray-500 lg:text-2xl mt-5 ml-13">ระบบ NBAC Repair System เกิดขึ้นได้อย่างไร <br>
        ...
        <li class="text-left font-semibold text-gray-700 lg:text-4xl mt-10">Nbac repair system มีประโยชน์อย่างไร ?</li>
        <p class="text-left font-semibold text-gray-500 lg:text-2xl mt-5 ml-13">ประโยชน์ของระบบ NBAC Repair System <br> ระบบ NBAC Repair System ไม่ได้เป็นเพียงแค่ระบบแจ้งซ่อมทั่วไป แต่ยังเป็นเครื่องมือสำคัญที่ช่วยยกระดับการจัดการงานซ่อมแซมอุปกรณ์คอมพิวเตอร์ภายในองค์กรให้มีประสิทธิภาพมากยิ่งขึ้น โดยมีประโยชน์หลัก ๆ ดังนี้:
